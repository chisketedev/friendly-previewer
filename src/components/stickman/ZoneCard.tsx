    ...
    >
      <Link to={`/menu/${zone.slug}`}>
        <div className="group relative overflow-hidden rounded-2xl bg-background/80 backdrop-blur-sm border-2 border-chicho-gold/30 hover:border-chicho-gold transition-all duration-300 hover:shadow-[0_0_30px_rgba(212,175,55,0.3)]">
          ...
          {/* Zone name with neon effect - centered and responsive */}
          <div className="relative px-2 pb-4 sm:pb-6 -mt-6 sm:-mt-8">
            <h3 className="font-architects text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center neon-text break-words leading-tight">
              {zone.name}
            </h3>
          </div>
        </div>
